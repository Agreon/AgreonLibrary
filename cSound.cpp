...
void cSound::loadSound(const char* path, string name)
{
...
void cSound::loadMusic(const char* path, string name)
{
...
void cSound::playSound(string name)
{
	...
	{
		Mix_PlayChannel(1,m_Chunks[name],0);
	}
